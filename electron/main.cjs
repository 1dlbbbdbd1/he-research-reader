    ...
    if (isDesktopSmoke) {
      ...
      void mainWindow.webContents.executeJavaScript(script, true)
        .then(async result => {
          ...
          workbenchLayoutMetrics.deepResearch = await require('./deep-research-ui-smoke.cjs').checkDeepResearchUi(mainWindow, workspaceService, workbenchService, screenshotRoot)
